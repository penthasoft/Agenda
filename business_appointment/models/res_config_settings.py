...
class res_config_settings(models.TransientModel):
    ...
    appoin_comp_tz = fields.Selection(
        related="appoin_comp_tz_company_id.partner_id.tz",
        readonly=False,
    )
    ba_auto_sale_order = fields.Selection(
        [("no", "No Auto Creation"),("draft", "Auto Draft Sale Order"), ("confirmed", "Auto Confirmed Sale Order"),],
